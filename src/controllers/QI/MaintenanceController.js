...
exports.cleanupPresentations = async (req, res) => {
    try {
        const results = {
            analysis: {},
            deleted: {},
        ...
        const deleteResult = await Presentation.deleteMany({ _id: { $in: idsToDelete } });
        ...
        const liquidProducts = await Product.find({ physicalState: 'liquido' }).maxTimeMS(15000);
        ...
        await Presentation.findByIdAndUpdate(cilindroId, { productCount: liquidProducts.length });
